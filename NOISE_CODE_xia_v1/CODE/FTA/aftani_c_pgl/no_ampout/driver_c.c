 ...
 */
    ...
    sprintf(phvelname, "/data/tarogato/yingjie/california/PRED_DISP/scalifornia_avg_phvel.dat");
 ...
 */
    sscanf(root, "COR_%[A-Z,a-z,0-9]_%[A-Z,a-z,0-9].", sta1, sta2);
    sprintf(name1, "/data/tarogato/yingjie/california/PRED_DISP/COR_%s_%s.SAC_PRED", sta1, sta2);
