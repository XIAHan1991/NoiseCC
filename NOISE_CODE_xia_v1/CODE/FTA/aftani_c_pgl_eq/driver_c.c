 ...
 */
    sscanf(root, "cut_%[A-Z,a-z,0-9]_%[A-Z,a-z,0-9].", sta1, sta2);
 ...
 */
    sscanf(root, "cut_%[A-Z,a-z,0-9]_%[A-Z,a-z,0-9].", sta1, sta2);
    sprintf(name1, "/home/cola/c/zhenxu2/china_eq/moredata/PRED/cut_%s_%s.Z.SAC_PRED", sta1, sta2);
//    sprintf(name1, "/home/cola/a/zhenxu2/GLOBAL_DISP/wenchuan/COR_%s_%s.SAC_PRED", sta1, sta2);
    printf("Group velocity prediction curve: %s\n",name1);
    if((fd = fopen(name1,"r")) == NULL) {
      sscanf(root, "cut_%[A-Z,a-z,0-9]_%[A-Z,a-z,0-9].", sta2, sta1);
      sprintf(name1, "/home/cola/c/zhenxu2/china_eq/moredata/PRED/cut_%s_%s.Z.SAC_PRED", sta1, sta2);
//      sprintf(name1, "/home/cola/a/zhenxu2/GLOBAL_DISP/wenchuan/COR_%s_%s.SAC_PRED", sta1, sta2);
      if((fd = fopen(name1,"r")) == NULL) {
        printf("Can not find file %s\n",name1);
