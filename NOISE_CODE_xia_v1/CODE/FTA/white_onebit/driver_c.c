...
static float seis_in[8000000],seis_out[8000000];
static float seis_outamp[8000000],seis_outph[8000000];
double t1,t2,t3,t4;
...
//  fprintf(ff,"/home/nshapiro/PROGS/SAC/bin/sac2000 << END\n");
  ...
  if ( !read_sac("smooth.sac", sig, &shd1, 4000000 ) )
    {
