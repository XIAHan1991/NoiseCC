...
c ==========================================================
     ...
     1  seis_out,seis_outamp,seis_outph,ns,dom)
      ...
      real*4    seis_in(8000000),seis_out(8000000)
      real*4   seis_outamp(8000000), seis_outph(8000000)
c ---
      integer*4 k,ns,nk,i
      real*8    plan1,plan2
      real*8    dom
      double complex czero,s(8000000),sf(8000000)
c ---
      czero = (0.0d0,0.0d0)
...
c===============================================================
      ...
      integer*4 nk,npow
      double complex sf(8000000)
      real*8    d1,d2,f,dpi,ss,s(8000000)
      integer*4 i,j
c ---
...
c=s==============================================================
      ...
      integer*4 number,nk
      double complex sf(8000000)
      real*8    sorig(8000000), sout(8000000),dom
      real*8   f,sum, avg
c ---
        do i = 1,nk
